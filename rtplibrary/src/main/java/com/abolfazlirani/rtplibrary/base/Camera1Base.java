...
import com.abolfazlirani.encoder.input.audio.CustomAudioEffect;
...
import com.abolfazlirani.encoder.input.audio.MicrophoneManagerManual;
import com.abolfazlirani.encoder.input.audio.MicrophoneMode;
import com.abolfazlirani.encoder.input.video.Camera1ApiManager;
import com.abolfazlirani.encoder.input.video.CameraCallbacks;
...
import com.abolfazlirani.encoder.input.video.GetCameraData;
...
import com.abolfazlirani.rtplibrary.util.FpsListener;
import com.abolfazlirani.rtplibrary.view.GlInterface;
import com.abolfazlirani.rtplibrary.view.LightOpenGlView;
import com.abolfazlirani.rtplibrary.view.OffScreenGlThread;
...
public abstract class Camera1Base
   ...
   *
   * @param cameraFacing front or back camera. Like: {@link com.abolfazlirani.encoder.input.video.CameraHelper.Facing#BACK}
   * {@link com.abolfazlirani.encoder.input.video.CameraHelper.Facing#FRONT}
   * @param width of preview in px.
   * @param height of preview in px.
   * @param rotation camera rotation (0, 90, 180, 270). Recommended: {@link
   * com.abolfazlirani.encoder.input.video.CameraHelper#getCameraOrientation(Context)}
   */
